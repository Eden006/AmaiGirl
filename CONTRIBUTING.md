...
<p><a href="#zh-cn">简体中文</a> | <a href="#en-us">English</a></p>
...
- 涉及许可证与分发内容，请同步更新 `NOTICE` / `THIRD_PARTY_LICENSES.md`
...
- Update `NOTICE` / `THIRD_PARTY_LICENSES.md` when distribution/license-related content changes
